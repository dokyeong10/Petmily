<template>
  <div>
    <div>
      <div v-if="replyJoins">
        <div v-for="(reply, idx) in replyJoins" :key="idx+'a'" class="d-flex justify-content-between">
          ...
          <button v-if="!reply.toggle" @click="changeToggle(idx)" class="btn-white pe-3"> 답글 </button>
