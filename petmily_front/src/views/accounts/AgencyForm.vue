              ...
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <button
                    ...
                    aria-label="Close"
                    @click="agencycodeSearchDataDelete"
                  ></button>
                </div>
                <div class="modal-body d-flex">
                  <input
                    v-model="state.agencycodeSearchKeyword"
                    type="text"
                    class="form-control radius-border br"
                    placeholder="검색어를 입력하세요."
                    @keyup.enter="agencycodeSearch"
                  />
                  <button type="button" class="btn-up" @click="agencycodeSearch">검색</button>
                </div>
                <ul v-if="state.agencycodeSearchData">
                  <li
                    v-for="value in state.agencycodeSearchData"
                    :key="value.agencycode"
                    @click="getAgencyData(value)"
                    data-bs-dismiss="modal"
                    id="myDiv"
                  >
                    기관 이름: {{ value.agencyname }} | 기관 코드: {{ value.agencycode }}
                  </li>
                </ul>
